        ...
        <>
              ...
              {w.budget ? (
                <>
                  ...
                  <p className="notice small">
                    Negative headroom is a budget breach. No listed purchases
                    does not confirm a complete commitment register. A
                    purchasing budget is not available cash and does not
                    establish payment coverage.
                  </p>
                </>
              ) : (
                <EmptyState
          ...
          >
            ...
            <p className="panel-footnote">
              Coverage is period-specific. Unknown or omitted categories prevent
              a claim that all business payments are covered.
            </p>
          </Panel>
        </>
      ) : tab === 'Commitments' ? (
                    ...
                    <tr key={c.id}>
                      <td>
                        ...
                        <small className="block muted">
                          {w.suppliers.find((s) => s.id === c.supplierId)
      ...
      {tab !== 'Commitments' && (
        ...
        >
          <div className="table-toolbar">
            ...
            >
              {['All records', 'Outstanding', 'Overdue', 'Unscheduled'].map(
                (v) => (
