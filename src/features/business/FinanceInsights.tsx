    ...
    >
        ...
        <div className="overview-grid">
          <section aria-label={`${party} overdue aging`}>
            ...
            <p className="panel-footnote">
              ...
              record due today is not overdue. Missing due dates stay unknown.
            </p>
          </section>
      ...
      >
        ...
        {result.timeline.length ? (
          ...
          <p className="notice">
            No reconciled outstanding records have expected dates in this
            window. Missing dates and excluded records do not establish zero
            future cash flow.
          </p>
        )}
        <p className="panel-footnote">
          Unscheduled: {money(result.unscheduled, currency)} · expected before
          this window: {money(result.beforeWindow, currency)} · expected after
          it: {money(result.beyondWindow, currency)}. Dates are expectations,
